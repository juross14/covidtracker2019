            ...
            <div className="checklisttodo">
              <div className="iconvirus">
                <svg
                  ...
                  viewBox="0 0 512 512"
                  className="svg-inline--fa fa-shield-virus fa-w-16 fa-3x"
                >
                  <path
                    fill="currentColor"
            ...
            <div className="localset">
              <button onClick={this.storelocal}>
                ...
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 448 512"
                  className="svg-inline--fa fa-arrow-alt-square-right fa-w-14 fa-2x"
                >
                  <path
                    fill="currentColor"
              ...
              <Pdf targetRef={ref} filename="covid.healthtips.pdf">
